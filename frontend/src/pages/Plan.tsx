		...
		<div className='min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50 py-8'>
			<div className='mx-auto max-w-7xl px-4'>
				...
				<div className='mb-8 text-center'>
					...
					<h1 className='mb-2 text-4xl font-bold bg-gradient-to-r from-orange-600 via-orange-500 to-orange-600 bg-clip-text text-transparent'>AI Trip Planner</h1>
					<p className='text-lg text-gray-600'>Let AI create your perfect itinerary in seconds</p>
				</div>
				...
				<div className='grid gap-8 lg:grid-cols-2'>
					...
					<Card className='h-fit p-8 shadow-xl'>
						...
						<form onSubmit={handleSubmit} className='space-y-6'>
							...
							{/* Submit Button */}
							<Button type='submit' disabled={isGenerating} className='w-full bg-gradient-to-r from-orange-500 to-orange-600 py-3 text-lg font-semibold hover:from-orange-600 hover:to-orange-700 disabled:from-gray-400 disabled:to-gray-500'>
								{isGenerating ? (
